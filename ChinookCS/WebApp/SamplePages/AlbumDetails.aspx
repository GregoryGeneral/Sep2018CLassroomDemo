...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h3>Accessing Data from ListView and Griview</h3>
    ...
    <div class="row">
        <asp:GridView ID="TracksOfAlbums" runat="server" DataSourceID="AlbumTrackODS" AllowPaging="True" OnSelectedIndexChanged="TracksOfAlbums_SelectedIndexChanged">
            <Columns>
                <asp:TemplateField HeaderText="ID">
                    <ItemTemplate>
                        <asp:Label Text='<%# Eval("TrackId") %>' runat="server" ID="ComposerLabel" /></td>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Media">
                                        <ItemTemplate>
                 <asp:Label Text='<%# Eval("MediaTypeId") %>' runat="server" ID="MediaTypeId" /></td>
                    </ItemTemplate>
                </asp:TemplateField>
            ...
            <asp:Label Text='<%# Eval("Composer") %>' runat="server" ID="ComposerLabel" /></td>
                ...
                <asp:TemplateField HeaderText="Price">
                                        ...
                                        <ItemTemplate>
                 <asp:Label Text='<%# Eval("UnitPrice") %>' runat="server" ID="UnitPrice" /></td>
                    </ItemTemplate>
                </asp:TemplateField>
     ...
     <div class="row">
        ...
        <asp:Label ID="SumeSize" runat="server" ></asp:Label>
    </div>
     <div class="row">

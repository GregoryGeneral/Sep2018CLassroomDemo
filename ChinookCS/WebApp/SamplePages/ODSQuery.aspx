...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DropDownList ID="ArtistList" runat="server" DataSourceID="ArtistListODS" DataTextField="Name" DataValueField="ArtistId"
         AppendDataBoundItems="true">
        <asp:ListItem Value="0">Select ...</asp:ListItem>
        </asp:DropDownList>
    <asp:LinkButton ID="FetchArtist" runat="server">Fetch</asp:LinkButton>
    <br /><br />
    <!--Bind("xxx") is both read and write
        Eval("xxx") is write only-->
    <asp:GridView ID="AlbumList" runat="server" DataSourceID="AlbumListODS" AutoGenerateColumns="False">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Artist" SortExpression="ArtistID">
                <ItemTemplate>
                    <asp:DropDownList ID="AlbumArtistList" runat="server" DataSourceID="ArtistListODS" 
                        DataTextField="ArtistId" DataValueField="ArtistId" selectedvalue='<%# Eval("ArtistID") %>'></asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
        ...
        <EmptyDataTemplate>
            No data found
            <!---Dispaly something when no data was found-->
        </EmptyDataTemplate>
    </asp:GridView>
